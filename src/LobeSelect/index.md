...
| classNames               | Semantic DOM class names                                                                                         | `LobeSelectClassNames`                    | -                                        |
...
| labelRender              | Custom render for selected label                                                                                 | `(option: LobeSelectOption) => ReactNode` | -                                        |
...
| options                  | Select options                                                                                                   | `LobeSelectOptions`                       | -                                        |
...
| options  | Options in this group | `LobeSelectOption[]` | -       |
