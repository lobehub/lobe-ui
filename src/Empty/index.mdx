---
title: Empty
description: Empty component displays an empty state with customizable icon, emoji, image, title, description, and action buttons, in default, dashed, and stack variants. It's commonly used to indicate that there's no data or content to display.
...
import DemoStack from './demos/Stack.tsx?demo';
