...
import DemoConfigProvider from './demos/ConfigProvider.tsx?demo';
import DemoDynamicImport from './demos/DynamicImport.tsx?demo';
...
<Demo of={DemoConfigProvider} layout="bare" />

### Dynamic import resources

<Demo editable={false} of={DemoDynamicImport} layout="bare" />
