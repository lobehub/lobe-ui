...
<code src="./demos/active.tsx" nopadding></code>
...
| onActive                 | Called when an option is highlighted (hover or ↑↓ keyboard) but not yet confirmed. Called with `null` on close. Useful for live-preview. | `(value \| null, option?) => void`       | -                                        |
