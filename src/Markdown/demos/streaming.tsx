...
import { STREAM_ANIMATION_DEMO_CONTROLS } from '@/Markdown/SyntaxMarkdown/streamAnimation.constants';
...
export default () => {
  ...
  const {
  ...
  } = useControls(
    {
      ...
      streamAnimationWindowMs: {
        max: STREAM_ANIMATION_DEMO_CONTROLS.windowMs.max,
        min: STREAM_ANIMATION_DEMO_CONTROLS.windowMs.min,
        step: STREAM_ANIMATION_DEMO_CONTROLS.windowMs.step,
        value: STREAM_ANIMATION_DEMO_CONTROLS.windowMs.defaultValue,
      },
      streamAnimationOverlapMs: {
        max: STREAM_ANIMATION_DEMO_CONTROLS.overlapMs.max,
        min: STREAM_ANIMATION_DEMO_CONTROLS.overlapMs.min,
        step: STREAM_ANIMATION_DEMO_CONTROLS.overlapMs.step,
        value: STREAM_ANIMATION_DEMO_CONTROLS.overlapMs.defaultValue,
      },
      streamAnimationBacklogRate: {
        max: STREAM_ANIMATION_DEMO_CONTROLS.backlogRate.max,
