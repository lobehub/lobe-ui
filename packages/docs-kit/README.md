...
| `themeConfig.apiHeader`                | `string`                                             | Repository base URL used to derive each component doc's "Source" and "Edit" links (`{apiHeader}/tree/master/...`, `{apiHeader}/edit/master/...`).                                                                                                                       |
